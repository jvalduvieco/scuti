...
from domain.cqrs.effects import Command, Event, Query, Effect
from domain.model.modules import DomainModule
from infrastructure.domain.cqrs.bus.effect_handlers.asynchronous_class import build_asynchronous_class_effect_handler
from infrastructure.domain.cqrs.bus.effect_handlers.synchronous_class import build_synchronous_class_effect_handler
from infrastructure.domain.cqrs.cqrs_module import CQRSDomainModule
from infrastructure.registering.inspection.plum_inspection import inspect
from infrastructure.tools.list import unique
...
class Application:
    def __init__(self,
        ...
        self.__domain_instances: Optional[Dict[Type[DomainModule], DomainModule]] = self.__instantiate_domain_modules()
        self.__injector: Optional[Injector] = injector if injector is not None else self.__build_injector()
        self.__threads = []
